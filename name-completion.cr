...
If a component of RoyalCommands states that it supports //online name-completion//, then it will allow for a name
argument to be partially completed when entered; the name will complete itself if a player matching it is online.
